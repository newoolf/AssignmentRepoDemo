...
export class PatientService {
	...
	/**
	 * Request a patient by ID
	 * @param client - The authenticated FHIR client
	 * @param id - The patient's resource ID
	 * @returns The patient resource
	 */
	async requestPatientById(client: Client, id: string): Promise<fhirclient.FHIR.Patient> {
	...
	/**
	 * Request patients by identifier (e.g., MRN, SSN)
	 * @param client - The authenticated FHIR client
	 * @param system - The identifier system
	 * @param value - The identifier value
	 * @returns Bundle of matching patient resources
	 */
	async requestPatientByIdentifier(client: Client, system: string, value: string): Promise<fhirclient.FHIR.Bundle> {
